...
const BannerSection = () => {
  return (
    <div
      className="xl:mx-40 mx-10 mb-10 mt-32 lg:mx-20 flex items-center justify-center rounded-[20px] bg-no-repeat bg-center bg-cover"
      ...
      <div className="flex justify-center py-8 md:px-16 lg:px-32">
        <div className="flex flex-col justify-center items-center gap-2 md:gap-4">
          ...
          <input
            ...
            name="email"
            className="md:text-sm xl:text-base text-xs font-work-sans font-medium outline-none bg-primary rounded-[20px] px-4 md:px-8 py-2 xl:py-4 w-[70%] xl:w-[80%] md:w-auto uppercase placeholder-slate-700"
          />
