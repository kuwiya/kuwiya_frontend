...
const ClaimCoupon = () => {
  ...
  if (isLoading) {
    return <div className="font-semibold text-2xl text-center">Loading...</div>;
  }
  ...
  return (
    <>
      <Navbar scrolling />
      <main className="md:pt-32 pt-20 px-6 md:px-20">
        ...
        <section className="py-7 space-y-5 lg:px-20">
        ...
        <section className="space-y-3 mt-7 lg:px-20 mb-24">
          <p className="font-normal lg:text-[19px] lg:pl-9">Similar Coupon</p>
