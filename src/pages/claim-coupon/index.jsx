...
const ClaimCoupon = () => {
  ...
  return (
    <>
      <Navbar scrolling />
      <main className="md:pt-32 pt-20 px-6 md:px-16 lg:p-[136px]">
        <div className="">
        ...
        <section className="py-7 space-y-5">
          <div className="flex relative h-[169px] md:h-[372px] lg:h-auto">
            ...
            <div className="flex bg-gradient-to-r from-[#000000] from-[0%] to-[#666666] to-[100%] rounded-lg p-1 md:p-2">
              <div className="flex-1 md:flex-[55%] h-[169px] lg:h-auto lg:pt-12 md:pt-8 pt-2 md:pb-6 lg:pl-16 md:pl-10 pl-7 text-[#000000]">
          ...
          <div className="space-y-4">
            ...
            {/* <p className="flex gap-1 items-center text-[13px] font-normal">
              ...
              <span>({coupon?.number_of_ratings})</span>
              <span> . {coupon?.restaurant?.location} Km</span>
              <span>
                <GpsIcon />
              </span>
            </p> */}
        ...
        <section className="space-y-3 mt-7 mb-24">
          <p className="font-medium lg:text-[19px]">Similar Coupon</p>
          <ClaimCouponFiltering
            restName={coupon?.restaurant?.name}
            key={coupon?.id}
          />
        </section>
      </main>
