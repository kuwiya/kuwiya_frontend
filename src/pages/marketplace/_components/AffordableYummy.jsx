...
const AffordableYummy = ({ image }) => {
  return (
    <section className="mx-6 md:mx-16 lg:mx-[136px] my-16 relative font-lato font-bold text-base md:text-2xl lg:text-5xl h-[139px] md:h-auto">
      <div className="flex">
        <div className="flex-[64%] md:flex-[70%] py-6 md:py-0 rounded-l-[10px] text-center flex flex-col justify-center items-center lg:gap-3 text-white bg-gradient-to-r from-[#F29309] from-[0%] via-[14%] via-[#8D5D1E] to-[#000000] to-[50%]">
