...
import InfoSectionCard from "../../../homepage/_components/info_section/_components/info_section_card";
// import InfoSectionCard from "./_components/info_section_card";

const InfoSection = () => {
  return (
    <div className="py-2 text-center flex flex-col mt-8 md:mt-20">
      <div className="flex flex-col w-full mx-auto md:w-full md:pb-10 px-3 md:px-8 md:space-y-2 space-y-1">
