    ...
    <div className="py-2 text-center flex flex-col lg:mt-28">
      ...
      <div className="m-2 space-y-2">
        <div className="group flex flex-col rounded-lg text-white" tabindex="1">
          <div className="flex cursor-pointer items-center md:p-8 p-4 justify-between bg-[#F8A434]">
          ...
          <div className="bg-[#af7222] md:text-base text-sm  px-8 p-3 invisible h-auto max-h-0 text-start opacity-0 transition-all group-focus:visible group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000">
